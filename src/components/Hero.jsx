    ...
    <>
      <div className="hero">
        ...
        <div className="hero-container">
          <div className="intro">
            <h1>
              Nice to meet you! I'm <span>Marcio Lopes</span>.
            </h1>
            <p>
              I'm a front-end developer who has a passion for building things
      ...
      <div className="about">
        <div className="about-container">
          ...
          <p>
            ...
            Finance) and it was a point in life where i didn't know what i
            wanted to do in the future. I found out about Python and decided to
            self teach myself but it didn't go as far as i expected. then i
            ...
            skills I've learned since i started the course :
          </p>
